...
export function loadConfig(overrides?: Partial<Config>): Config {
  ...
  return {
    ...
    micRmsThresholdDb: overrides?.micRmsThresholdDb ?? fileConfig.micRmsThresholdDb ?? -55,
    sysRmsThresholdDb: overrides?.sysRmsThresholdDb ?? fileConfig.sysRmsThresholdDb ?? -55,
